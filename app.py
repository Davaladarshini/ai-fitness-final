...
import json
# Import the function from the new logic file
from webcam_stream import generate_frames 
...
# --- Route to serve the live video stream ---
@app.route('/video_feed')
def video_feed():
    """
    Returns a streaming Response object using the generator function.
    """
    return Response(
        generate_frames(),
